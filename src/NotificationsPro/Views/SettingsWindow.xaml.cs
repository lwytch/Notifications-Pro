...
public partial class SettingsWindow : Window
{
    ...
    private void OnPickOverlayLaneColorClick(object sender, RoutedEventArgs e)
    {
        if (sender is not FrameworkElement { Tag: string propertyName, DataContext: ViewModels.OverlayLaneEntry entry })
            return;
