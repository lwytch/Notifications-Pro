...
- [ ] Release v1.1.10.34 hardening pass: update README release notes plus repo-map/status/changelog planning docs, rebuild a fresh signed MSIX, rerun build/test/vulnerability checks, and finish local install verification once the replacement signing cert is trusted for the current machine.
